...
import { LineChart, Wallet, LogOut, Newspaper, Trophy, Menu, X, Gamepad2, Users, User, Gift } from 'lucide-react'; // Added Trophy, Gamepad2, Users, User, Gift
...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { path: '/cardstore', label: '卡牌商店', icon: Gift, color: 'text-amber-400' },
